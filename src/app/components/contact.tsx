    ...
    <section id="contact" className="bg-gray-900 py-12">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start px-6">
        ...
        <div className="contact-form flex-1 bg-gray-800 p-8 rounded-lg shadow-lg">
          <h2 className="text-4xl font-bold mb-4 text-teal-600">
            Get in Touch
          </h2>
          <form>
            <div className="form-group mb-4 flex flex-col md:flex-row md:space-x-4">
              <div className="flex-1">
                <input
                  ...
                  required
                  className="w-full border border-gray-300 rounded p-3 focus:outline-none focus:ring-2 focus:ring-blue-600 bg-transparent placeholder-light-gray mb-4"
                />
              </div>
              <div className="flex-1">
                <input
            ...
            <button
              type="submit"
              className="bg-cyan-700 text-white py-3 px-6 rounded-lg border border-cyan-500 flex items-center hover:bg-cyan-500 transition duration-300"
            >
